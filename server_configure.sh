...
#SET IP LBaaS
echo "exports.ipnscl='$nscl_private';" | tee --append /home/ubuntu/OpenMTC-Chula/openmtc/settings/ipserv.js
...
echo "exports.fipnip='$nscl_private_floatingIp';" >> tee --append /home/ubuntu/OpenMTC-Chula/openmtc/settings/ipserv.js
